...
- Name: posts.spec.ts >> 게시글 삭제 >> 올바른 비밀번호 입력 시 글이 삭제되고 목록으로 이동한다
- Location: e2e/posts.spec.ts:186:7
...
Call log:
  - waiting for getByRole('button', { name: '삭제' })
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e5]:
    - generic [ref=e6]:
      - paragraph [ref=e7]: 존재하지 않는 게시글입니다
      - link "목록으로 돌아가기" [ref=e8] [cursor=pointer]:
        - /url: /
  - contentinfo [ref=e9]:
    - generic [ref=e10]: 단순 게시판 서비스
