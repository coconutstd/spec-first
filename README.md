...
[`.claude/agents/architecture-writer.md`](.claude/agents/architecture-writer.md) — 아키텍처 문서 작성·리뷰 전용 서브에이전트.

이 프로젝트의 `docs/ARCHITECTURE.md`는 해당 에이전트의 지침을 기반으로 작성됐다.  
에이전트가 적용하는 핵심 원칙:
